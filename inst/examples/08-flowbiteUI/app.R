...
ui <- div(
  class = "grid grid-rows-3 gap-4 mb-6 p-2",

  use_flowbite(),

  div(
    div("Tabs", class = "text-2xl font-bold"),
  ...
  div(
    div("Input Validation", class = "text-2xl font-bold"),
...
<div>
  ...
  div(
    div("Sidebar", class = "text-2xl font-bold"),
