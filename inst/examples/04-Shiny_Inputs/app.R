...
form1 <- rounded_container(
  div(
    tags$label("for" = "email", class = "block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300", "Your email"),
    tags$input(type = "email", id = "email", class = "bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500", placeholder = "name@flowbite.com")
  ),
  div(
    class = "mt-6",
  ...
  div(
    ...
    div(
      ...
      tags$input(id = "remember", type = "checkbox", value = "", class = "w-4 h-4 border border-gray-300 rounded bg-gray-50 focus:ring-3 focus:ring-blue-300 dark:bg-gray-700 dark:border-gray-600 dark:focus:ring-blue-600 dark:ring-offset-gray-800")
    ),
    tags$label("for" = "remember", class = "ml-2 text-sm font-medium text-gray-900 dark:text-gray-300", "Remember me")
  ),
