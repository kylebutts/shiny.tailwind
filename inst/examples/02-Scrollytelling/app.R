...
section <- function(section_title = "Section", section_subtitle = "", ...) {
  div(
    ...
    div(
      ...
      h3(
        class = "text-3xl lg:text-base text-gray-500 font-medium",
        section_title
      ),
      p(
        class = "text-2xl lg:text-sm text-gray-400 italic pt-1",
        section_subtitle
      )
    ),
    # Content
...
ui <- div(
  ...
  tags$main(
    ...
    div(
      ...
      h1(
        class = "block text-8xl tracking-tight font-extrabold text-white",
        "Palmer's Penguins"
      ),
      div(
        ...
        icon(
          "chevron-down",
          class = "md:text-2xl lg:text-4xl text-white animate-bounce"
        )
      )
    ),
    # Page 2 -------------------------------------------------------------------
    div(
      ...
      div(
        ...
        div(
          ...
          section(
            ...
            div(
              ...
              shiny.tailwind::twSelectInput(
                ...
                container_class = "block w-2/3 lg:w-full",
                label_class = "text-lg lg:text-sm text-gray-600 italic",
          ...
          section(
            "Plot Options",
            "Personalize the plot to make it production ready.",
            div(
              class = "grid grid-flow-row grid-cols-2 lg:grid-cols-2 gap-y-8 gap-x-8",
        ...
        div(
          ...
          icon(
            "chevron-down",
            class = "text-8xl lg:text-4xl text-gray-800 animate-bounce"
          )
        )
      )
    ),
    ...
    div(
      ...
      div(
        ...
        p(
          ...
          a(
            href = "https://www.uaf.edu/cfos/people/faculty/detail/kristen-gorman.php",
            target = "_blank",
            "Dr. Kristen Gorman"
          ),
          "and the ",
          a(
            href = "https://pal.lternet.edu/",
            target = "_blank",
          ...
          "See more about the data and R package",
          a(
